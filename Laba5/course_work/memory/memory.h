...
protected:
    ...
    virtual logger *get_logger() const noexcept;

    virtual void dump_allocator_state(bool is_allocate) const noexcept;
    ...
    virtual void *get_buddies(void *target_ptr) const;

    virtual bool is_free_block(void *target_ptr) const;
