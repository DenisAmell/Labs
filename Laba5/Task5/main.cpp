    ...
    unsigned int iterations_count)
{
    ...
    memory *allocator = new memory_buddy_system(log, nullptr, 20, memory::allocate_mode::best_fit);
...
void allocator_demo_2()
{
    ...
    memory *allocator = new memory_buddy_system(log, nullptr, 10, memory::allocate_mode::first_fit);
    ...
    // auto *ptr3 = allocator->allocate(255);
    allocator->deallocate(ptr);
    // allocator->deallocate(ptr2);
    // allocator->deallocate(ptr3);
    // std::cout << "gde log?" << std::endl;
    delete allocator;
    delete log;
    delete builder;
}
